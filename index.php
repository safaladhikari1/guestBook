...
?>
                ...
                <div class="col-md-6 col-lg-6">
                    <fieldset class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span class="required">*</span>
                            <input class="form-control" type="text" id="lastname" name="lname" aria-describedby="required-lastname">
                ...
                <fieldset class="form-group">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="mailinglistcheck">Please add me to your mailing list</label>
                        </div>
                    </div>
        ...
        <br>
        <a class="btn btn-primary" href="https://safal.greenriverdev.com/sdev305/guestbook/admin.php" role="button" style="margin-bottom: 10px">Go to Admin Page</a>
